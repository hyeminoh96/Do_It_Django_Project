from django.views.generic import ListView # ListView : post 목록을 보여주는 장고 내장 함수
from django.views.generic import DetailView # DetailView : post의 상세 내용을 보여주는 장고 내장 함수
...
#     return render(
#         request,
#         'blog/post_detail.html', # post 한 개를 sing~.html에 렌더링
#         {
#             'post' : post,
#         }
#     )
